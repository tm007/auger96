            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex items-center justify-between mb-6">
                    <h2 className="text-3xl font-bold tracking-tight uppercase text-white flex items-center gap-3">
                        LIVE
                        {data?.isLive && <span className="w-3 h-3 rounded-full bg-red-600 animate-pulse shadow-[0_0_10px_red]" />}
                    </h2>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 h-[70vh]">
                    ...
                    <div className="lg:col-span-3 bg-zinc-900 relative border border-zinc-800">
                        <iframe
                            src="https://player.twitch.tv/?channel=auger&parent=localhost&parent=auger96-hub.vercel.app"
                    ...
                    <div className="lg:col-span-1 bg-black border border-zinc-800 flex flex-col">
                        <div className="p-2 border-b border-zinc-800 bg-zinc-950 text-xs font-mono text-zinc-500">
                            CHAT
                        </div>
                        <iframe
                            src="https://www.twitch.tv/embed/auger/chat?parent=localhost&parent=auger96-hub.vercel.app&darkpopout"
                            ...
                            {loading ? (
                                ...
                                data?.vods && data.vods.length > 0 ? (
                                    data.vods.map((vod: any) => (
                                        ...
                                        >
                                            <img src={vod.thumbnail_url.replace("%{width}", "640").replace("%{height}", "360")} alt={vod.title} className="w-full h-full object-cover opacity-60 group-hover:opacity-100 transition-opacity" />
